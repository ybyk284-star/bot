        ...
        if message.photo:
            ...
            with open(filename, 'rb') as f:
                await message.reply_video(
                    video=f,
                    caption="🔥 **تم تحميل ومعالجة الفيديو بنجاح يا يونس!** 🎬🚀",
                    reply_to_message_id=message.message_id
                )
            ...
            status_msg = await message.reply_text(
                "⚡ جاري معالجة الفيديو ورفع جودته وسلاسة إطاراته يا يونس... 🎬🔥",
                reply_to_message_id=message.message_id
            )
            ...
            with open(output_path, 'rb') as f:
                await message.reply_video(
                    video=f,
                    caption="🔥 **تمت معالجة الفيديو ورفع جودته بنجاح يا يونس!** 🎬🚀\nجاهز للترند يا وحش 🔥",
                    reply_to_message_id=message.message_id
                )
            ...
            await message.reply_text(
                "يا يونس يا بطل، أرسل لي **فيديو** أو **صورة** وسأقوم بمعالجتها فوراً! 📥",
                reply_to_message_id=message.message_id
            )
